...
Log "GENES-ERA1 START (seed $SEED) -- 16 agents, $GENS gens, 3x(6/4) rotation, predictors-ON, BC-on, GPU lane (cap 2); new bail/exit genes auto-sampled; caps ctx<=128/d<=256; output $DIR"
